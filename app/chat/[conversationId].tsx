...
// Move MessageBubble outside to avoid hooks order issues
    ...
    >
      ...
      {!isUser && (
        <TouchableOpacity
          ...
          onPress={() => onCopyMessage(item.content)}
        >
...
export default function ChatScreen() {
  ...
  const renderMessage = ({ item, index }: { item: Message; index: number }) => (
    <MessageBubble item={item} index={index} onCopyMessage={handleCopyMessage} />
  );
